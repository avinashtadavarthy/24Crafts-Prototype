...
public class SwipeFragment extends android.support.v4.app.Fragment implements TinderCard.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        Point windowSize = com.twenty.four.crafts.encounters.Utils.getDisplaySize(getActivity().getWindowManager());
        ...
        for (Profile profile : com.twenty.four.crafts.encounters.Utils.loadProfiles(getActivity().getApplicationContext())) {
