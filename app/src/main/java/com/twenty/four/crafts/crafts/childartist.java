...
public class childartist extends CommontoAll {
    ...
    float Height; //(either in Ft/Inches or in cm)
    int Weight;// (kgs)
    boolean ifdance,ifsing,ifpriorexperience;
    String priorexperience_desc[],pic_links[],video_links[];
    String guardian_name,guardian_no,guardian_relation;//if mother/father
}
