...
public class MyData {
    ...
    static Integer[] drawableArray = {R.drawable.icon_circle,R.drawable.icon_circle,R.drawable.icon_circle,R.drawable.icon_circle,
            R.drawable.icon_circle,0,0,R.drawable.icon_circle,R.drawable.icon_circle,R.drawable.icon_circle,
